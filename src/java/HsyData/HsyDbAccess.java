...
public class HsyDbAccess implements Serializable{
    ...
    {
        String sql="insert into hsy_product(product_code,product_name,batch_no,quantity,"
        ...
        try{
            ...
            pst.setString(26, p.getShop_name());
            pst.setString(27, p.getWhy_need());
            pst.setString(28, p.getReturn_type());
