...
<html>
    ...
    <body>
       <%
        ...
        try{
        Product p=new Product(product_code, product_name, batch_code,  quantity, product_for, category, specification, manufacturer, country, type_of_product, veg_or_nveg, mrp, discount, description,ingredients, weight, size, color,flavor,volume, quality, reliability, date_of_entry, exp_date, mfd_date,"","","no");
