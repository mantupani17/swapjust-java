<%-- 
    Document   : viewByFlavor
    Created on : Apr 19, 2017, 6:26:09 PM
    Author     : Handshakeyou
--%>
...
ArrayList<Product> products = HsyDbAccess.viewProductLikeFlavor(flavor);
ArrayList<Product> pros = HsyDbAccess.viewProductNotLikeFlavor(flavor);
%>
<!DOCTYPE html>
<html>
    <head>
