<%-- 
    ...
    Created on : Apr 11, 2017, 7:02:18 PM
    Author     : Handshakeyou
--%>
...
List<Product> products = (List<Product>)HsyDbAccess.viewDataByName(pname);
List<Product> pros = (List<Product>)HsyDbAccess.viewDataByNotName(pname);
%>
<!DOCTYPE html>
<html>
    <head>
