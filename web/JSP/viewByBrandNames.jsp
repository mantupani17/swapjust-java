<%-- 
    Document   : viewByBrandNames
    Created on : Apr 12, 2017, 7:50:33 PM
    Author     : Handshakeyou
--%>
...
ArrayList<Product> products = (ArrayList<Product>)HsyDbAccess.viewByBrandNames(bname);
ArrayList<Product> pros =HsyDbAccess.viewNotLikeBrandNames(bname);
%>
<!DOCTYPE html>
<html>
    <head>
