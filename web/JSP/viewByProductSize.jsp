<%-- 
    Document   : viewByProductSize
    Created on : Apr 18, 2017, 10:18:20 AM
    Author     : Handshakeyou
--%>
...
ArrayList<Product> products = (ArrayList<Product>)HsyDbAccess.viewBySizes(size);
ArrayList<Product> pros = HsyDbAccess.viewNotLikeSize(size);
%>
<!DOCTYPE html>
<html>
    <head>
...
<link href="../JSP/header.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        <table style="width:100%; border:none; margin-left: 4%;">
              <tr>
           <%
               int i=0;
        for(Product pro: products)
        {
           ...
           %>
           <td>
               <div class="l2 m3 s12"  style="width:100%;" >
...
<%
    ...
    <div class="w3-third w3-margin-bottom w3-hover-shadow w3-border-0" style=" margin-left:3%; width:100%;">
      <div class="w3-card-4">
          <img src="../items/BN/BN2.png" alt="Jane" style="width:200px;height: 150px;"/>
        <div class="w3-container">
             <div>
                        <span class="w3-text-deep-orange" ><%=pro.getProduct_name() %></span><br/>
                         <i class="fa fa-heart" style="color:#FF0000"></i>
